...
You do not need to use Google Maps. If you choose not to, an alternate map is available which uses Esri geocoding, Leaflet and OpenStreetMap.
...
- [ArcGIS for Developers account](https://developers.arcgis.com/en/plans) - this is a condition of use of [esri-leaflet-geocoder](https://github.com/Esri/esri-leaflet-geocoder) and the underlying ArcGIS geocoding Api, used by the Alt Map. This is currently (March 2021) free if you have a developer account and are making <1,000,000 requests/month. See [Terms](https://github.com/Esri/esri-leaflet-geocoder#terms-and-conditions) and [Cost](https://github.com/Esri/esri-leaflet-geocoder#cost) in the esri-leaflet-geocoder project, as well as the ArcGIS website. 
