...
class Answer(models.Model):
    ...
    solves_level = models.ForeignKey(Level, on_delete=models.CASCADE, null=True, related_name='answers')
    # Which level should this answer lead to
    leads_to_level = models.ForeignKey(Level, on_delete=models.CASCADE, null=True, related_name='+')
